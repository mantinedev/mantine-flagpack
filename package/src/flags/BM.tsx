  ...
  return (
    ...
    >
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 24">
        <defs>
          <mask id="mantine-uw65m0t48" fill="#fff">
            <path fillRule="evenodd" d="M0 0h32v24H0z" />
          </mask>
          <mask id="mantine-skd1d7pr4" fill="#fff">
            <use fillRule="evenodd" xlinkHref="#mantine-k7y7h73l9" />
          </mask>
          <mask id="mantine-21reuc338" fill="#fff">
            <use fillRule="evenodd" xlinkHref="#mantine-117d4h7sb" />
          </mask>
          <mask id="mantine-amgtdgx09" fill="#fff">
            <use fillRule="evenodd" xlinkHref="#mantine-pl37morsg" />
          </mask>
          <mask id="mantine-o4l5miu19" fill="#fff">
            <use fillRule="evenodd" xlinkHref="#mantine-yqyotn7gz" />
          </mask>
          <path id="mantine-k7y7h73l9" d="M0 0h32v24H0z" />
          <path
            id="mantine-117d4h7sb"
          ...
          />
          <path id="mantine-yqyotn7gz" d="M0 0h18v14H0z" />
        </defs>
        <g fill="none" fillRule="evenodd" mask="url(#mantine-uw65m0t48)">
          <use fill="#af0100" xlinkHref="#mantine-k7y7h73l9" />
          <g mask="url(#mantine-skd1d7pr4)">
            <g transform="translate(21 11)">
              <use fill="#fff" xlinkHref="#mantine-117d4h7sb" />
              <path
                fill="#cf142b"
                ...
                mask="url(#mantine-21reuc338)"
              />
              <g mask="url(#mantine-21reuc338)">
                <path
                  fill="#5dc852"
          ...
          <g mask="url(#mantine-skd1d7pr4)">
            <use fill="#2b409a" xlinkHref="#mantine-yqyotn7gz" />
            <g mask="url(#mantine-o4l5miu19)">
              <g fillRule="nonzero">
                <path
                  fill="#f7fcff"
