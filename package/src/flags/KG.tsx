  ...
  return (
    ...
    >
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 24">
        <defs>
          <mask id="mantine-66wcvuchn" fill="#fff">
            <path fillRule="evenodd" d="M0 0h32v24H0z" />
          </mask>
          <mask id="mantine-7jc1lu6xg" fill="#fff">
            <use fillRule="evenodd" xlinkHref="#mantine-x5cy5gjb4" />
          </mask>
          <path id="mantine-x5cy5gjb4" d="M0 0h32v24H0z" />
        </defs>
        <g fill="none" fillRule="evenodd" mask="url(#mantine-66wcvuchn)">
          <use fill="#c51918" xlinkHref="#mantine-x5cy5gjb4" />
          <g fill="#ffdc17" mask="url(#mantine-7jc1lu6xg)">
