  ...
  return (
    ...
    >
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 24">
        <defs>
          <filter id="mantine-6sfi3t73t" width="100%" height="100%" x="0%" y="0%">
          ...
          />
          <mask id="mantine-k0wnlgfjt" fill="#fff">
            <path fillRule="evenodd" d="M0 0h32v24H0z" />
          </mask>
        </defs>
        <g fill="none" fillRule="evenodd" mask="url(#mantine-k0wnlgfjt)">
          <g fill="#f7fcff">
          ...
          <g transform="translate(12.8 2)">
            ...
            />
            <use fill="#000" filter="url(#mantine-6sfi3t73t)" xlinkHref="#mantine-9i8k21knc" />
            <use fill="#feca00" xlinkHref="#mantine-9i8k21knc" />
          </g>
        </g>
      </svg>
    </Box>
