  ...
  return (
    ...
    >
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 24">
        <defs>
          <mask id="mantine-g7xnqppi1" fill="#fff">
            <path fillRule="evenodd" d="M0 0h32v24H0z" />
          </mask>
          <mask id="mantine-eled9w1ce" fill="#fff">
            <use fillRule="evenodd" xlinkHref="#mantine-hzpj3h68q" />
          </mask>
          <path id="mantine-hzpj3h68q" d="M0 0h32v24H0z" />
        </defs>
        <g fill="none" fillRule="evenodd" mask="url(#mantine-g7xnqppi1)">
          <use fill="#f7fcff" xlinkHref="#mantine-hzpj3h68q" />
          <path fill="#bf2714" d="M0 0h32v6H0zm0 18h32v6H0z" mask="url(#mantine-eled9w1ce)" />
          <g mask="url(#mantine-eled9w1ce)">
            <path
              fill="#5277b9"
