...
export function HTFlag({ size = 40, radius, sx, ...others }: FlagProps) {
  return (
    <Box
      sx={[
        (theme) => ({
    ...
    >
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 24">
        <defs>
          <mask id="mantine-rn4pewfyz" fill="#fff">
            <path fillRule="evenodd" d="M0 0h32v24H0z" />
          </mask>
          <mask id="mantine-otu70zpz3" fill="#fff">
            <use fillRule="evenodd" xlinkHref="#mantine-tbxnph025" />
          </mask>
          <mask id="mantine-rm6xz7ags" fill="#fff">
            <use fillRule="evenodd" xlinkHref="#mantine-3d72d5rr7" />
          </mask>
          <path id="mantine-tbxnph025" d="M0 0h32v24H0z" />
          <path id="mantine-3d72d5rr7" d="M0 0h12v8H0z" />
        </defs>
        <g fill="none" fillRule="evenodd" mask="url(#mantine-rn4pewfyz)">
          <use fill="#2e42a5" xlinkHref="#mantine-tbxnph025" />
          <path fill="#e31d1c" d="M0 12h32v12H0z" mask="url(#mantine-otu70zpz3)" />
          <g mask="url(#mantine-otu70zpz3)">
            <g transform="translate(10 8)">
              <use fill="#fff" xlinkHref="#mantine-3d72d5rr7" />
              <path
                fill="#279e19"
                d="M0 6.578a22.18 22.18 0 016-.711c2.08.03 4.08.327 6 .889V8H0z"
                mask="url(#mantine-rm6xz7ags)"
              />
              <g mask="url(#mantine-rm6xz7ags)">
