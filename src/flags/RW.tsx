...
export function RWFlag({ size = 40, radius, sx, ...others }: FlagProps) {
  return (
    <Box
      sx={[
        (theme) => ({
    ...
    >
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 24">
        <defs>
          <mask id="mantine-w55d7mtil" fill="#fff">
            <path fillRule="evenodd" d="M0 0h32v24H0z" />
          </mask>
          <mask id="mantine-16v9kaph9" fill="#fff">
            <use fillRule="evenodd" xlinkHref="#mantine-fl1vzw7mp" />
          </mask>
          <path id="mantine-fl1vzw7mp" d="M0 0h32v24H0z" />
        </defs>
        <g fill="none" fillRule="evenodd" mask="url(#mantine-w55d7mtil)">
          <use fill="#feca00" xlinkHref="#mantine-fl1vzw7mp" />
          <path fill="#3ca5d9" d="M0 0h32v14H0z" mask="url(#mantine-16v9kaph9)" />
          <path fill="#5a962a" d="M0 18h32v6H0z" mask="url(#mantine-16v9kaph9)" />
          <g fill="#ffdc17" mask="url(#mantine-16v9kaph9)">
