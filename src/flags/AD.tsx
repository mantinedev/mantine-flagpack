...
export function ADFlag({ size = 40, radius, sx, ...others }: FlagProps) {
  return (
    <Box
      sx={[
        (theme) => ({
    ...
    >
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 24">
        <defs>
          <path id="mantine-9cgcd1r4h" d="M0 0h32v24H0z" />
          <path
            id="mantine-nc7j02dn4"
        ...
        <g fill="none" fillRule="evenodd">
          <mask id="mantine-ve6lnd231" fill="#fff">
            <use xlinkHref="#mantine-9cgcd1r4h" />
          </mask>
          <g mask="url(#mantine-ve6lnd231)">
            ...
            <g transform="translate(12.373 7.144)">
              <mask id="mantine-bv9t6xxsn" fill="#fff">
                <use xlinkHref="#mantine-nc7j02dn4" />
              </mask>
              <use fill="#BF9937" xlinkHref="#mantine-nc7j02dn4" />
              <g mask="url(#mantine-bv9t6xxsn)">
