...
export const NIFlag = createFlag(
  'NI',
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 24">
    <defs>
      <mask id="mantine-ald88hxw3" fill="#fff">
        <path fillRule="evenodd" d="M0 0h32v24H0z" />
      </mask>
      <mask id="mantine-xbm4tfwi6" fill="#fff">
        <use fillRule="evenodd" xlinkHref="#mantine-idnuwu0jh" />
      </mask>
      <mask id="mantine-pz7lukkvc" fill="#fff">
        <use fillRule="evenodd" xlinkHref="#mantine-6m5mvfz9t" />
      </mask>
      <path id="mantine-idnuwu0jh" d="M0 0h32v24H0z" />
      <path id="mantine-6m5mvfz9t" d="M2.738.004L.002 4.735h5.516z" />
    </defs>
    <g fill="none" fillRule="evenodd" mask="url(#mantine-ald88hxw3)">
      <use fill="#f7fcff" xlinkHref="#mantine-idnuwu0jh" />
      <path fill="#0080ec" d="M0 0h32v8H0zm0 16h32v8H0z" mask="url(#mantine-xbm4tfwi6)" />
      <g mask="url(#mantine-xbm4tfwi6)">
        <path
          fill="#d0ab00"
          fillRule="nonzero"
        ...
        <g transform="translate(13.236 8.945)">
          <use fill="#7cdfff" xlinkHref="#mantine-6m5mvfz9t" />
          <g mask="url(#mantine-pz7lukkvc)">
