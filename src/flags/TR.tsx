...
export function TRFlag({ size = 40, radius, sx, ...others }: FlagProps) {
  return (
    <Box
      sx={[
        (theme) => ({
    ...
    >
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 24">
        <defs>
          <mask id="mantine-oxworppdz" fill="#fff">
            <path fillRule="evenodd" d="M0 0h32v24H0z" />
          </mask>
          <mask id="mantine-mebrg3jzg" fill="#fff">
            <use fillRule="evenodd" xlinkHref="#mantine-8burlcl25" />
          </mask>
          <path id="mantine-8burlcl25" d="M0 0h32v24H0z" />
        </defs>
        <g fill="none" fillRule="evenodd" mask="url(#mantine-oxworppdz)">
          <use fill="#e31d1c" xlinkHref="#mantine-8burlcl25" />
          <path
            fill="#f7fcff"
