...
export function BMFlag({ size = 40, radius, sx, ...others }: FlagProps) {
  return (
    <Box
      sx={[
        (theme) => ({
    ...
    >
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 24">
        <defs>
          <mask id="mantine-rxp5juu9l" fill="#fff">
            <path fillRule="evenodd" d="M0 0h32v24H0z" />
          </mask>
          <mask id="mantine-mit4w4iop" fill="#fff">
            <use fillRule="evenodd" xlinkHref="#mantine-6u5002m8h" />
          </mask>
          <mask id="mantine-eknxpv5ih" fill="#fff">
            <use fillRule="evenodd" xlinkHref="#mantine-ud5826gx9" />
          </mask>
          <mask id="mantine-xb55nlnjl" fill="#fff">
            <use fillRule="evenodd" xlinkHref="#mantine-d0qewp0mc" />
          </mask>
          <mask id="mantine-t0v8d72yp" fill="#fff">
            <use fillRule="evenodd" xlinkHref="#mantine-xe7zeg6m0" />
          </mask>
          <path id="mantine-6u5002m8h" d="M0 0h32v24H0z" />
          <path
            id="mantine-ud5826gx9"
          ...
          />
          <path id="mantine-xe7zeg6m0" d="M0 0h18v14H0z" />
        </defs>
        <g fill="none" fillRule="evenodd" mask="url(#mantine-rxp5juu9l)">
          <use fill="#af0100" xlinkHref="#mantine-6u5002m8h" />
          <g mask="url(#mantine-mit4w4iop)">
            <g transform="translate(21 11)">
              <use fill="#fff" xlinkHref="#mantine-ud5826gx9" />
              <path
                fill="#cf142b"
                ...
                mask="url(#mantine-eknxpv5ih)"
              />
              <g mask="url(#mantine-eknxpv5ih)">
                <path
                  fill="#5dc852"
          ...
          <g mask="url(#mantine-mit4w4iop)">
            <use fill="#2b409a" xlinkHref="#mantine-xe7zeg6m0" />
            <g mask="url(#mantine-t0v8d72yp)">
              <g fillRule="nonzero">
                <path
                  fill="#f7fcff"
