...
export function KGFlag({ size = 40, radius, sx, ...others }: FlagProps) {
  return (
    <Box
      sx={[
        (theme) => ({
    ...
    >
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 24">
        <defs>
          <mask id="mantine-oc9onoi9c" fill="#fff">
            <path fillRule="evenodd" d="M0 0h32v24H0z" />
          </mask>
          <mask id="mantine-jys0z7s9i" fill="#fff">
            <use fillRule="evenodd" xlinkHref="#mantine-px04zx2am" />
          </mask>
          <path id="mantine-px04zx2am" d="M0 0h32v24H0z" />
        </defs>
        <g fill="none" fillRule="evenodd" mask="url(#mantine-oc9onoi9c)">
          <use fill="#c51918" xlinkHref="#mantine-px04zx2am" />
          <g fill="#ffdc17" mask="url(#mantine-jys0z7s9i)">
