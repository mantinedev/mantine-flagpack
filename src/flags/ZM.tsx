...
export function ZMFlag({ size = 40, radius, sx, ...others }: FlagProps) {
  return (
    <Box
      sx={[
        (theme) => ({
    ...
    >
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 24">
        <defs>
          <mask id="mantine-sxen9ztgb" fill="#fff">
            <path fillRule="evenodd" d="M0 0h32v24H0z" />
          </mask>
          <mask id="mantine-ys4x85kpi" fill="#fff">
            <use fillRule="evenodd" xlinkHref="#mantine-jq2h1vkyd" />
          </mask>
          <path id="mantine-jq2h1vkyd" d="M0 0h32v24H0z" />
        </defs>
        <g fill="none" fillRule="evenodd" mask="url(#mantine-sxen9ztgb)">
          <path fill="#f7fcff" d="M0 0h32v24H0z" />
          <use fill="#5eaa22" xlinkHref="#mantine-jq2h1vkyd" />
          <g mask="url(#mantine-ys4x85kpi)">
