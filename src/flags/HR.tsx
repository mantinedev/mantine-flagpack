...
export function HRFlag({ radius, sx, ...others }: FlagProps) {
  return (
    <Box
      sx={[
        (theme) => ({
        ...
        <g mask="url(#mantine-mliis1obg)">
          ...
          <g mask="url(#mantine-0uhxpex8c)">
            ...
            <path
              fill="#FECA00"
              fillRule="evenodd"
              d="M15.75 6.585c.483 0 .529-.521.529-.876-.124-.197-.099-.338-.494-.338-.396 0-.44.12-.556.338 0 .355.039.876.521.876zM16.293 5.113c.482 0 .529-.521.529-.876-.124-.197-.099-.338-.494-.338-.396 0-.44.12-.556.338 0 .355.039.876.521.876zM15.238 5.113c.483 0 .529-.521.529-.876-.123-.197-.099-.338-.494-.338s-.44.12-.556.338c0 .355.039.876.521.876z"
              clipRule="evenodd"
            />
            <path
              fill="#2E42A5"
            ...
            <g fill="#C51918" mask="url(#mantine-n364lc2gn)">
              <path d="M12.436 6.638l-.25-.59c.538-.236 1.447-.38 2.403-.437l.037.642c-.89.052-1.73.184-2.19.385zM12.014 5.21l-.25-.59c.537-.235 1.694-.426 2.65-.482l.037.641c-.89.053-1.978.23-2.437.431z" />
            </g>
            <path
              fill="#2E42A5"
              stroke="#fff"
            ...
            <g fillRule="evenodd" clipRule="evenodd" mask="url(#mantine-7ukig7tie)">
              <path
                fill="#FECA00"
            ...
            <g mask="url(#mantine-7al75pnr6)">
              ...
              <path
                fill="#fff"
                d="M19.283 5.722l.05-.208c.902.224 1.86.58 2.557.913l-.09.194a14.127 14.127 0 00-2.517-.899zM19.016 6.577l.05-.209c.902.224 1.735.528 2.432.86l-.09.194a12.767 12.767 0 00-2.392-.845z"
              />
              <path
                fill="#272727"
