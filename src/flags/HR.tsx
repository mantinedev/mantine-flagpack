      ...
      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 32 24">
        ...
        <g mask="url(#mantine-0cmuzmm84)">
          ...
          <g mask="url(#mantine-8v0ypd7rk)">
            ...
            <g fill="#C51918" mask="url(#mantine-0zk5wu65z)">
            ...
            <g fillRule="evenodd" clipRule="evenodd" mask="url(#mantine-gsioti6hk)">
              <path
                fill="#FECA00"
