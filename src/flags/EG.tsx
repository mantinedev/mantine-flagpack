...
export function EGFlag({ size = 40, radius, sx, ...others }: FlagProps) {
  return (
    <Box
      sx={[
        (theme) => ({
    ...
    >
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 24">
        <defs>
          <mask id="mantine-nr6540vxc" fill="#fff">
            <path fillRule="evenodd" d="M0 0h32v24H0z" />
          </mask>
          <mask id="mantine-vzno264td" fill="#fff">
            <use fillRule="evenodd" xlinkHref="#mantine-gcq1b33fa" />
          </mask>
          <path id="mantine-gcq1b33fa" d="M0 0h32v24H0z" />
        </defs>
        <g fill="none" fillRule="evenodd" mask="url(#mantine-nr6540vxc)">
          <use fill="#f7fcff" xlinkHref="#mantine-gcq1b33fa" />
          <path fill="#bf2714" d="M0 0h32v8H0z" mask="url(#mantine-vzno264td)" />
          <path fill="#272727" d="M0 16h32v8H0z" mask="url(#mantine-vzno264td)" />
          <g fill="#c09302" fillRule="nonzero" mask="url(#mantine-vzno264td)">
