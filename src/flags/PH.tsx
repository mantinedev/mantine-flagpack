  ...
  return (
    ...
    >
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 24">
        <defs>
          <mask id="mantine-3vk18dfsl" fill="#fff">
            <path fillRule="evenodd" d="M0 0h32v24H0z" />
          </mask>
          <mask id="mantine-9kysmrkm1" fill="#fff">
            <use fillRule="evenodd" xlinkHref="#mantine-ljg0l2j5n" />
          </mask>
          <mask id="mantine-rrgo2biml" fill="#fff">
            <use fillRule="evenodd" xlinkHref="#mantine-p8kmyc6ob" />
          </mask>
          <path id="mantine-ljg0l2j5n" d="M0 0h32v24H0z" />
          <path id="mantine-p8kmyc6ob" d="M0 0v24l18-12z" />
        </defs>
        <g fill="none" fillRule="evenodd" mask="url(#mantine-3vk18dfsl)">
          <use fill="#bf2714" xlinkHref="#mantine-ljg0l2j5n" />
          <path fill="#3d58db" d="M0-2h32v14H0z" mask="url(#mantine-9kysmrkm1)" />
          <use fill="#f7fcff" xlinkHref="#mantine-p8kmyc6ob" />
          <g fill="#feca00">
            <path
