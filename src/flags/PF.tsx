...
export function PFFlag({ size = 40, radius, sx, ...others }: FlagProps) {
  return (
    <Box
      sx={[
        (theme) => ({
    ...
    >
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 24">
        <defs>
          <mask id="mantine-r1mxbccnd" fill="#fff">
            <path fillRule="evenodd" d="M0 0h32v24H0z" />
          </mask>
          <mask id="mantine-i4sh97gzu" fill="#fff">
            <use fillRule="evenodd" xlinkHref="#mantine-0i0p409kx" />
          </mask>
          <path id="mantine-0i0p409kx" d="M0 0h32v24H0z" />
        </defs>
        <g fill="none" fillRule="evenodd" mask="url(#mantine-r1mxbccnd)">
          <use fill="#f7fcff" xlinkHref="#mantine-0i0p409kx" />
          <path fill="#bf2714" d="M0 0h32v6H0zm0 18h32v6H0z" mask="url(#mantine-i4sh97gzu)" />
          <g mask="url(#mantine-i4sh97gzu)">
            <path
              fill="#5277b9"
