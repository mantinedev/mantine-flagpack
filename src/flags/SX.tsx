...
export function SXFlag({ size = 40, radius, sx, ...others }: FlagProps) {
  return (
    <Box
      sx={[
        (theme) => ({
    ...
    >
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 24">
        <defs>
          <mask id="mantine-qb0s8k8kc" fill="#fff">
            <path fillRule="evenodd" d="M0 0h32v24H0z" />
          </mask>
          <mask id="mantine-qcf55bjff" fill="#fff">
            <use fillRule="evenodd" xlinkHref="#mantine-3ct3020ss" />
          </mask>
          <mask id="mantine-941t65ewo" fill="#fff">
            <use fillRule="evenodd" xlinkHref="#mantine-2k5sediqy" />
          </mask>
          <path id="mantine-3ct3020ss" d="M0 0h32v24H0z" />
          <path id="mantine-2k5sediqy" d="M0-2v28l20-14z" />
        </defs>
        <g fill="none" fillRule="evenodd" mask="url(#mantine-qb0s8k8kc)">
          <use fill="#e31d1c" xlinkHref="#mantine-3ct3020ss" />
          <path fill="#2e42a5" d="M0 12h32v12H0z" mask="url(#mantine-qcf55bjff)" />
          <use fill="#f7fcff" xlinkHref="#mantine-2k5sediqy" />
          <g mask="url(#mantine-941t65ewo)">
