...
export function TKFlag({ size = 40, radius, sx, ...others }: FlagProps) {
  return (
    <Box
      sx={[
        (theme) => ({
    ...
    >
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 24">
        <defs>
          <mask id="mantine-vojc5yevz" fill="#fff">
            <path fillRule="evenodd" d="M0 0h32v24H0z" />
          </mask>
          <mask id="mantine-ipzurb9e5" fill="#fff">
            <use fillRule="evenodd" xlinkHref="#mantine-nnkidptb6" />
          </mask>
          <path id="mantine-nnkidptb6" d="M0 0h32v24H0z" />
        </defs>
        <g fill="none" fillRule="evenodd" mask="url(#mantine-vojc5yevz)">
          <use fill="#2e42a5" xlinkHref="#mantine-nnkidptb6" />
          <path
            fill="#f7fcff"
