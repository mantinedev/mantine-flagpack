...
export function AUFlag({ size = 40, radius, sx, ...others }: FlagProps) {
  return (
    <Box
      sx={[
        (theme) => ({
    ...
    >
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 24">
        <defs>
          <mask id="mantine-vudpqqgpz" fill="#fff">
            <path fillRule="evenodd" d="M0 0h32v24H0z" />
          </mask>
          <mask id="mantine-5w0vr44l7" fill="#fff">
            <use fillRule="evenodd" xlinkHref="#mantine-7uuwgx61d" />
          </mask>
          <mask id="mantine-nwpser3dn" fill="#fff">
            <use fillRule="evenodd" xlinkHref="#mantine-x70nzbojz" />
          </mask>
          <path id="mantine-7uuwgx61d" d="M0 0h32v24H0z" />
          <path id="mantine-x70nzbojz" d="M0 0h18v14H0z" />
        </defs>
        <g fill="none" fillRule="evenodd" mask="url(#mantine-vudpqqgpz)">
          <use fill="#2e42a5" xlinkHref="#mantine-7uuwgx61d" />
          <g mask="url(#mantine-5w0vr44l7)">
            <use fill="#2b409a" xlinkHref="#mantine-x70nzbojz" />
            <g mask="url(#mantine-nwpser3dn)">
              <g fillRule="nonzero">
                <path
                  fill="#f7fcff"
          ...
          <g fill="#f7fcff" fillRule="nonzero" mask="url(#mantine-5w0vr44l7)">
