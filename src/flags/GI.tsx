...
export function GIFlag({ size = 40, radius, sx, ...others }: FlagProps) {
  return (
    <Box
      sx={[
        (theme) => ({
    ...
    >
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 24">
        <mask id="mantine-tqpnc56sh" fill="#fff">
          <path fillRule="evenodd" d="M0 0h32v24H0z" />
        </mask>
        <g fill="none" fillRule="evenodd">
          <path fill="#f7fcff" d="M0 0h32v24H0z" mask="url(#mantine-tqpnc56sh)" />
          <g mask="url(#mantine-tqpnc56sh)">
