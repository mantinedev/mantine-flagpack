...
export function NUFlag({ size = 40, radius, sx, ...others }: FlagProps) {
  return (
    <Box
      sx={[
        (theme) => ({
    ...
    >
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 24">
        <defs>
          <mask id="mantine-f9i17xr4c" fill="#fff">
            <path fillRule="evenodd" d="M0 0h32v24H0z" />
          </mask>
          <mask id="mantine-nsdi4lfwg" fill="#fff">
            <use fillRule="evenodd" xlinkHref="#mantine-goo07gvdi" />
          </mask>
          <mask id="mantine-3s7do377n" fill="#fff">
            <path fillRule="evenodd" d="M0 0h32v16H0z" />
          </mask>
          <path id="mantine-goo07gvdi" d="M0 0h32v24H0z" />
        </defs>
        <g fill="none" fillRule="evenodd" mask="url(#mantine-f9i17xr4c)">
          <use fill="#2e42a5" xlinkHref="#mantine-goo07gvdi" />
          <path fill="#feca00" d="M0 16h32v8H0z" mask="url(#mantine-nsdi4lfwg)" />
          <g mask="url(#mantine-nsdi4lfwg)">
            <g mask="url(#mantine-3s7do377n)">
              <g fillRule="nonzero">
                <path
                  fill="#fff"
