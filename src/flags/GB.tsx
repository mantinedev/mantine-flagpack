...
export function GBFlag({ radius, sx, ...others }: FlagProps) {
  return (
    <Box
      sx={[
        (theme) => ({
    ...
    >
      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 32 24">
        ...
        <g mask="url(#mantine-5y9v6o66t)">
          ...
          <g mask="url(#mantine-19mtrxrum)">
            <mask
              id="mantine-i5td87h4l"
              style={{ maskType: 'alpha' }}
              width="32"
              height="24"
              x="0"
            ...
            <g mask="url(#mantine-i5td87h4l)">
              ...
              />
              <mask id="mantine-tio8eqy5v" fill="#fff">
                <path
                  fillRule="evenodd"
